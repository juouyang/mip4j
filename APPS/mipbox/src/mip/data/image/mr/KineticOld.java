...
//        k.render();
    ...
    private double initGlandular() {
        ...
        ImageStatistics is = new ShortStatistics(IJUtils.getProcessorFromShortImage(firstMiddleSlice));
        // TODO magic number
    ...
    private void colorMapping(boolean onlyROI) {
        ...
        ColorProcessor[] cps = new ColorProcessor[mrStudy.T0.getSize()];
        {
            for (int i = 0; i < cps.length; i++) {
                ...
                ByteProcessor bp = NO_BACKGROUND ? null : IJUtils.getByteProcessorFromShortImage(t1, t1.getWindowCenter(), t1.getWindowWidth());
